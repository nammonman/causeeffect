...
namespace Subtegral.SceneGraphSystem.Editor
{
    ...
    {
        private string _fileName = "New Scene Tree";
        ...
        {
            _graphView = new SceneGraphView(this)
            {
        ...
        private void RequestDataOperation(bool save)
        {
            ...
            {
                var saveUtility = SceneGraphSaveUtility.GetInstance(_graphView);
                if (save)
                {
        ...
        private void GenerateBlackBoard()
        {
            ...
            {
                _graphView.AddPropertyToBlackBoard(SceneExposedProperty.CreateInstance(), false);
            };
