...
public class ScreenFader : MonoBehaviour
{
    ...
    public void FadeBlackInOutCaller(float f)
    {
        StartCoroutine(FadeBlackSequence(f));
    }

    private IEnumerator FadeBlackSequence(float f)
    {
        yield return StartCoroutine(FadeBlackIn());
        yield return StartCoroutine(HoldSeconds(f));
    ...
    public IEnumerator HoldSeconds(float f)
    {
